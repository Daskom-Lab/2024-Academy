We are really sorry, since all the mentors are currently too busy to build all contents in the javascript part so we are giving you these references for you to learn more about it insetad:
